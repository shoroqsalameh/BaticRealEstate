              ...
              <div class="card-body">
                <div class="container-fluid d-flex justify-content-between">
                  <div class="col-lg-3 ps-0">
                    <a href="#" class="noble-ui-logo logo-light d-block mt-3">Batic<span>Agent</span></a>                 
                  ...
                  <div class="col-lg-3 pe-0">
                    ...
                    <h4 class="text-end fw-normal">20 JD</h4>
                        ...
                        <div class="table-responsive">
                          <table class="table">
                              <tbody>
                                <tr>
                                  <td>Sub Total</td>
                                  <td class="text-end"> 20 JD</td>
                                </tr>
                                 
                                <tr>
                                  <td class="text-bold-800">Total</td>
                                  <td class="text-bold-800 text-end">  20 JD</td>
                                </tr>
                                <tr>
                                  <td>Payment Made</td>
                                  <td class="text-danger text-end">(-) 20 JD</td>
                                </tr>
                                <tr class="bg-dark">
