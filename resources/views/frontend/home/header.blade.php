                ...
                <div class="top-inner clearfix">
                    <div class="left-column pull-left">
                        <ul class="info clearfix">
                            ...
                            <li><i class="far fa-clock"></i>0770003334</li>
...
<div class="main-box">
<div class="logo-box">
    <figure class="logo"><a href="{{ url('/') }}"><h1 style="color:#2dbe6c">BA <span style="color: black">IT</span>C</h1></a></figure>
</div>
<div class="menu-area clearfix">
    <!--Mobile Navigaon Toggler-->
